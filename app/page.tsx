    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-primary">HappyDogSights</h1>
              <p className="text-sm text-muted-foreground">Hundefreundliche Aussichtspunkte</p>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Über 320 hundefreundliche Aussichtspunkte in 16 Bundesländern. Entdecke atemberaubende Panoramen mit deinem Vierbeiner.
          </p>
        </div>
      ...
      <section className="bg-secondary/10 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <h3 className="text-2xl font-bold text-center mb-12">Warum HappyDogSights?</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Finde hundefreundliche Aussichtspunkte auf der Karte</p>
            </div>
            <div className="text-center">
      ...
      <footer className="bg-primary/5 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center text-sm text-muted-foreground">
            <p>&copy; 2025 HappyDogSights. Alle Rechte vorbehalten.</p>
